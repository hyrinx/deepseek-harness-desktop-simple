...
;(function () {
  ...
  function initSettingsOverlay() {
    ...
    const DOM = {
      ...
      env: {
        appStatus: qs('appStatus'), appVersion: qs('appVersion'), appUpdate: qs('appUpdateBtn'),
        appProgress: qs('appProgress'), appFill: qs('appFill'), appProgressText: qs('appProgressText'),
        nodeStatus: qs('nodeStatus'), nodeVersion: qs('nodeVersion'), nodeUpdate: qs('nodeUpdateBtn'),
        nodejsProgress: qs('nodejsProgress'), nodejsFill: qs('nodejsFill'), nodejsProgressText: qs('nodejsProgressText'),
    ...
    const state = {
      ...
      env: {
        ...
        node: { ok: false, version: '', checking: false, localPath: '', globalPath: '' },
        nodejs: { downloading: false, downloadProgress: 0, downloadMessage: '' },
